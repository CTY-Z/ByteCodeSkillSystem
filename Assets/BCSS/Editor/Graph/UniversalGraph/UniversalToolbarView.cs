    ...
    public class UniversalToolbarView : ToolbarView
    {
        ...
        protected override void AddButtons()
        {
            AddButton(new GUIContent("", m_CreateNewToggleIcon, "新建Graph资产"), () =>
            {
                ...
                //            SkillAssetCallback.InitializeGraph(baseGraph);
                //        }, graphType);
                //}
                //
            ...
            AddToggle(new GUIContent(m_ConditionalToggleIcon, "开/关运行的面板"),
                graphView.GetPinnedElementStatus<SkillProcessorView>() !=
                DropdownMenuAction.Status.Hidden, (v) => graphView.ToggleView<SkillProcessorView>());
